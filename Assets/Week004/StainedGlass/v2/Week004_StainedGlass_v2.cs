...
[ExecuteInEditMode]
public class Week004_StainedGlass_v2 : MonoBehaviour
{
    ...
    {
        readonly Week004_StainedGlass_v2 owner;
        public MyClearOpaquePass(Week004_StainedGlass_v2 owner)
        {
            this.owner = owner;
    ...
    public class MyCopyDepthPass : ScriptableRenderPass
    {
        ...
        public MyCopyDepthPass(Week004_StainedGlass_v2 owner)
        {
            this.owner = owner;
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            //cmd.SetRenderTarget(owner.projColorRenderTarget); not work
        }
    ...
    public class MyProjectPass : ScriptableRenderPass
    {
        ...
        public MyProjectPass(Week004_StainedGlass_v2 owner)
        {
            this.owner = owner;
